        ...
        <nav className='flex xl:flex-row flex-col gap-6'>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <RippleButton rippleColor="#ADD8E6" className="text-base py-2 px-4 h-auto 2xl:text-xl 2xl:py-3 2xl:px-6 font-semibold">Сервисы</RippleButton>
                </DropdownMenuTrigger>
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <RippleButton rippleColor="#5b5cf0" className="text-base py-2 px-4 h-auto 2xl:text-xl 2xl:py-3 2xl:px-5 font-semibold">Решения</RippleButton>
                </DropdownMenuTrigger>
                <DropdownMenuContent className="mt-2 w-[900px] h-[600px] p-0 rounded-2xl overflow-hidden shadow-2xl border bg-[#23243a] text-white z-50 flex" align="start">
                    <div className="flex flex-col w-1/3 min-w-[200px] bg-[#23243a] border-r border-[#35365a] py-4">
                        {Decisions.map((cat, i) => (
            ...
            <Link href={'/documentation'}><RippleButton rippleColor="#5b5cf0" className="text-base py-2 px-4 h-auto 2xl:text-xl 2xl:py-3 2xl:px-6">Документация</RippleButton></Link>
            <Link href={'/blogs'}><RippleButton rippleColor="#5b5cf0" className="text-base py-2 px-4 h-auto 2xl:text-xl 2xl:py-3 2xl:px-6">Блоги</RippleButton></Link>
            <Link href={'/roadmap'}><RippleButton rippleColor="#5b5cf0" className="text-base py-2 px-4 h-auto 2xl:text-xl 2xl:py-3 2xl:px-6">Roadmap</RippleButton></Link>
            <Link href={'/contact'}><RippleButton rippleColor="#5b5cf0" className="text-base py-2 px-4 h-auto 2xl:text-xl 2xl:py-3 2xl:px-6">Контакты</RippleButton></Link>
        </nav>
    )
}